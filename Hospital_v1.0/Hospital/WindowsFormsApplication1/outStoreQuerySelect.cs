...
{
    public partial class outStoreQuerySelect : Form
    {
        public outStoreQuerySelect()
        {
            InitializeComponent();
        }
        ...
        {
            for (int i = 0; i < oSelectList.ibl.Count; ++i)
            {
                this.listBox1.Items.Add(oSelectList.ibl[i]);
            }
            for (int i = 0; i < oSelectList.ibr.Count; ++i)
            {
                this.listBox2.Items.Add(oSelectList.ibr[i]);
            }
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            for(int i =0;i<this.listBox1.Items.Count;++i)
            {
                ...
                oSelectList.ibl.Add(this.listBox1.SelectedItem.ToString());
            }
            for (int i = 0; i < this.listBox2.Items.Count; ++i)
            {
                this.listBox2.SetSelected(i, true);
                oSelectList.ibr.Add(this.listBox2.SelectedItem.ToString());
            }
